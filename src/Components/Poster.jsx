...
const Poster = () => {
  return (
    <div className="page3 w-full h-[90vh] md:h-[110vh] relative bg-[#E0D1B8] mt-[-10px]">

      <div className="h-[60vh]">

        <img
          className="absolute top-0 z-10 object-cover object-left"
          src={MeltingBg}
          alt=""
        />

        <img
          className="z-50 absolute bottom-0 md:bottom-[0%] h-[50vh] md:h-[100vh] w-full object-cover"
